...
#define ws2812_mask_set  (1<<ws2812_set)		// Bitmask to set the data out pin
#define ws2812_mask_clr  (1<<ws2812_set)		// Bitmask to clear the data out pin
